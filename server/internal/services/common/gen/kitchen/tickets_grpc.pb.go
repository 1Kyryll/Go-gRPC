...
const (
	TicketService_CreateTicket_FullMethodName        = "/kitchen.TicketService/CreateTicket"
	TicketService_GetTicketsByOrderID_FullMethodName = "/kitchen.TicketService/GetTicketsByOrderID"
)
...
type TicketServiceClient interface {
	...
	GetTicketsByOrderID(ctx context.Context, in *GetTicketsByOrderIDRequest, opts ...grpc.CallOption) (*GetTicketsByOrderIDResponse, error)
}
...
func (c *ticketServiceClient) GetTicketsByOrderID(ctx context.Context, in *GetTicketsByOrderIDRequest, opts ...grpc.CallOption) (*GetTicketsByOrderIDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTicketsByOrderIDResponse)
	err := c.cc.Invoke(ctx, TicketService_GetTicketsByOrderID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TicketServiceServer interface {
	...
	GetTicketsByOrderID(context.Context, *GetTicketsByOrderIDRequest) (*GetTicketsByOrderIDResponse, error)
...
func (UnimplementedTicketServiceServer) GetTicketsByOrderID(context.Context, *GetTicketsByOrderIDRequest) (*GetTicketsByOrderIDResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTicketsByOrderID not implemented")
}
...
func _TicketService_GetTicketsByOrderID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTicketsByOrderIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TicketServiceServer).GetTicketsByOrderID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TicketService_GetTicketsByOrderID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TicketServiceServer).GetTicketsByOrderID(ctx, req.(*GetTicketsByOrderIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TicketService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kitchen.TicketService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTicketsByOrderID",
			Handler:    _TicketService_GetTicketsByOrderID_Handler,
		},
	},
